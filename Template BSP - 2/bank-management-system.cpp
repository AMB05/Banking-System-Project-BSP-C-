...
{
	cout<< acno << setw(10) << " " << name << setw(10) << " " << typee << setw(6) << depositt <<endl
}
...
void display_sp(in);			 //function to display account details given by user
void modify_account(int);		 //function to modify record of file
void delete_account(nt);		 //function to delete record of file
void display_all);				 //function to display all account details
void deposit_withdraw(int int); // function to desposit/withdraw amount for given account
void intr();					 //introductory screen function
